                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_text text-center">
                        <div class="login_part_text_iner">
                            ...
                            <p>Please register an account for the best experience</p>
                            <a href="register.php" class="btn_3">Register</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            <h3>Welcome back ! <br> Login now</h3>
                            <?php
                                if (isset($_POST["dangnhap"])) {
                                    ...
                                    if (rowCount("SELECT * FROM taikhoan WHERE taikhoan='$email' && matkhau='$matkhau' && status =0") == 1) {
                                        ...
                                        $error = 'Account or password is incorrect. Please check again';
                                    }
                                }
                            ?>
                            <form class="row contact_form" action="" method="post" novalidate="novalidate">
                                ...
                                <div class="col-md-12 form-group p_star exampleInputName1">
                                    <input type="text" class="form-control"  name="email" value="" required placeholder="Account (Email)">
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <input type="password" class="form-control" name="matkhau" value="" required placeholder="Password">
                                </div>
