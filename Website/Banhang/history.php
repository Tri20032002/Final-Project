...
<body>
  ...
  <section class="cart_area padding_top1">
    <div class="container">
        ...
        ?>
            <form class="cart_inner" method="post" action="">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <div class="checkout_btn_inner">
                                        ...
                                        if($status ==1){
                                        ?>
                                           <p class="text-info">Wait for confirmation</p> 
                                        <?php
                                        }elseif($status ==2){
                                        ?>
                                            
                                           <p class="text-primary">Delivering</p> 
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="genric-btn primary circle" href="detail.php?id=<?= $item['id_sanpham'] ?>">See</a>
                                </td>
                ...
                <div class="checkout_btn_inner float-right">
                    <a class="btn_1" href="cart.php">Return to Cart</a>
                </div>
                </div>
            </form>
        <?php
        ...
        <div class="checkout_btn_inner float-right">
            <a class="btn_1" href="product.php">Buy now</a>
        </div>
        <?php
        }
