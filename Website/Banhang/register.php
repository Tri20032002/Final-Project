                                        ...
                                        if($sdt !=""){
                                            if($matkhau !=""){
                                                if ($matkhau!==$nlmatkhau) {
                                                    $error ='Re-enter incorrect password';
                                                }else{
                                            ...
                                            $error ='Phone number cannot be left blank';
                                        }
                                    }
                                    else{
                        ...
                        ?>
                            ...
                            <?php 
                                ...
                                <div class="col-md-12 form-group p_star">
                                    <input type="text" name="ten" class="form-control" required value="" placeholder="Name" required>
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <input type="email" class="form-control"  name="email" value="" placeholder="Email" required>
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <input type="text" class="form-control"  name="sdt" value="" placeholder="Phone Number" required>
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <input type="password" class="form-control"  name="matkhau" value="" placeholder="Password" required>
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <input type="password" class="form-control"  name="nlmatkhau" value="" placeholder="Enter the again password" required>
                                </div>
