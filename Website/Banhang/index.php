                                ...
                                <div class="col-lg-5 col-md-8">
                                    <div class="banner_text">
                                        <div class="banner_text_iner">
                                            ...
                                            <p><?= $item['mota'] ?></p>
                                            <a href="<?= $item['link'] ?>" class="btn_2">Buy now</a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="single_feature_post_text">
                        <p>Macbook</p>
                        <h3><?= $item['ten'] ?></h3>
                        <a href="detail.php?id=<?= $item['id'] ?>" class="feature_btn">See More Details<i class="fas fa-play"></i></a>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="subscribe_area_text text-center">
                        <h5>ENJOY WITH US</h5>
                        <h2>Sign up to be updated with the latest offers</h2>
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Input your email" aria-label="Recipient's username" aria-describedby="basic-addon2">
                            <div class="input-group-append">
                                <a href="#" class="input-group-text btn_2" id="basic-addon2">Follow now</a>
                            </div>
                        </div>
                    </div>
                </div>
