        ...
        ?>
            <form class="cart_inner" method="post" action="">
                <div class="table-responsive">
                    <a href="history.php" class="btn_1" style="float:right; margin-bottom:20px;">Order history</a>
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="genric-btn primary circle" href="?removeproduct=<?= $item['id_sanpham'] ?>">Delete</a>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="checkout_btn_inner">
                                        ...
                                        <textarea name="diachi" id="" cols="70" rows="4" placeholder="Enter delivery address" required> <?= $diachitaikhoan ?></textarea>
                                    </div>
                                </td>
                                <td></td>
                                <td>
                ...
                <div class="checkout_btn_inner float-right">
                    ...
                    <input class="btn_1" type='submit' name="dathang" value="Order now" style="border: none"/>
                </div>
                </div>
                <?php
                    } else {
                    ?>
                        <a href="product.php" class="btn_1" style="float:right; margin:0px 20px 20px 0px;">Buy now</a>
