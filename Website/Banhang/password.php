                    ...
                    <div class="login_part_form" style="padding-top:20px;">            
                        ...
                        <form action="" method="POST">
                            ...
                            ?>
                                ...
                                <div class="col-md-12 form-group p_star">
                                    <p>Old password*</p>
                                    <input type="password"  name="matkhaucu" class="form-control" placeholder="Enter old password" required>
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <p>New password*</p>
                                    <input type="password" class="form-control"  name="matkhau" placeholder="A new password" required>
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <p>Enter a new password*</p>
                                    <input type="password"  class="form-control"  name="nlmatkhau" placeholder="Enter a new password" required>
                                </div>
