          ...
          <div class="content-wrapper">
            <div class="row">
              ...
              <div class="col-sm-4 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h5 class="addfont">Total Actual Revenue of the month</h5>
                    <div class="row">
              ...
              <div class="col-sm-4 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h5 class="addfont">Total Estimated Revenue for the Month</h5>
                    <div class="row">
                      <div class="col-8 col-sm-12 col-xl-8 my-auto">
                        <div class="d-flex d-sm-block d-md-flex align-items-center">
              ...
              <div class="col-sm-4 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h5 class="addfont">Total Revenue Deductions</h5>
                    <div class="row">
                      <div class="col-8 col-sm-12 col-xl-8 my-auto">
                        <div class="d-flex d-sm-block d-md-flex align-items-center">
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title addfont">Monthly Sales Statistics</h4>
                    <div class="table-responsive">
                    <table class="table">
                      <thead>
                          <tr>
                              <th class="addfont" style="width: 100px">Numerical order</th>
                              <th class="addfont" style="width: 500px" >Fullname</th>
                              <th class="addfont" style="width: 400px" >Account (Email)</th>
                              <th class="addfont" style="width: 300px">Account Type</th>
                              <th class="addfont" style="width: 300px">Number of Orders Purchased</th>
                              <th class="addfont" style="width: 300px">Total Money</th>
                          </tr>
                      </thead>
                      <tbody>
