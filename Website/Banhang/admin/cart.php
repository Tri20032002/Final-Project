                            ...
                            <div class="card">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th class="addfont" style="width: 10px">Numerical order</th>
                                                <th class="addfont">User</th>
                                                <th class="addfont">Account (Email)</th>
                                                <th class="addfont">ID Order</th>
                                                <th class="addfont">Total Money</th>
                                                <th class="addfont">Time Order</th>
                                                <th class="addfont">Status</th>
                                                <th class="addfont">Function</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr class="addfont">
                                                ...
                                                <td>
                                                  <?php 
                                                    ...
                                                    if ($status==1) {
                                                      ?>
                                                      <span class="badge badge-info">Wait for confirmation</span>
                                                  <?php 
                                                    }else if($status==2){
                                                      ?>
                                                ...
                                                <i class="mdi mdi-file-check btn-icon-prepend"></i> Detail</a>
                                                  <?php 
                                                    if($status==1){
                                                      ?>
                                                      <a type="button" class="btn btn-success btn-icon-text" style="width: 130px" href="?action=update&id=<?= $row['id'] ?>" onclick="return confirm('Would you like to confirm this order?')">
                                                      <i class="mdi mdi-trending-up btn-icon-prepend"></i> Confirm </a>

                                                      <a type="button" class="btn btn-danger btn-icon-text" href="?action=delele&id=<?= $row['id'] ?>"onclick="return confirm('Do you want to cancel this order?')">
                                                      <i class="mdi mdi mdi-delete btn-icon-prepend"></i> Cancel</a>
                                                  <?php
                                                    }else if($status==2){
                                                      ?>
                                                      <a type="button" class="btn btn-success btn-icon-text" style="width: 130px" href="?action=update&id=<?= $row['id'] ?>" onclick="return confirm('Do you want to complete this order?')">
                                                      <i class="mdi mdi-trending-up btn-icon-prepend"></i> Complete</a>

                                                      <a type="button" class="btn btn-danger btn-icon-text" href="?action=delete&id=<?= $row['id'] ?>" onclick="return confirm('Do you want to cancel this order?')">
                                                      <i class="mdi mdi mdi-delete btn-icon-prepend"></i> Cancel</a>
                                                  <?php
                                                    }
                                                  ?>
