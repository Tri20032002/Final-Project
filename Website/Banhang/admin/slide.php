                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="addfont" style="width: 400px" >Title</th>
                                                <th class="addfont" style="width: 300px">Images</th>
                                                <th class="addfont" style="width: 500px" >Describe</th>
                                                <th><a type="button" class="btn btn-success btn-fw" style="width: 204px" href="addslide.php">Add Banner</a></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        ...
                                        ?>
                                            <tr class="addfont">
                                                ...
                                                <a type="button" class="btn btn-danger btn-icon-text" style="width: 120px" href="?id=<?= $row['id'] ?>" onclick="return confirm('Do you want to delete this slide?')">
                                                <i class="mdi mdi-cart-outline btn-icon-prepend"></i> Delete </a>
                                                </td>
                                            </tr>
                                        <?php
                                            }
