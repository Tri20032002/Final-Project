        ...
        if ($permission==1) {
            if (isset($_GET["id"])) {
                if(rowCount("SELECT * FROM sanpham WHERE id_danhmuc={$_GET['id']}")>0){
                    echo '<script>alert("Only categories without products can be deleted")</script>';
                            ...
                            <div class="card">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th class="addfont">Numerical order</th>
                                                <th class="addfont" style="width: 500px" >Name Product</th>
                                                <th class="addfont">The number of products</th>
                                                <th></th>
                                                <th></th>
                                                <th></th>
                                                <th></th>
                                                <th><a type="button" class="btn btn-success btn-fw addfont" style="width: 162px" href="addcategory.php">Add Category</a></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <a type="button" class="btn btn-danger btn-icon-text" href="?id=<?= $row['id_dm'] ?>" onclick="return confirm('Do you want to delete this category?')">
