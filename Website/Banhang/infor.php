                    ...
                    <div class="login_part_form" style="padding-top:20px;">            
                        <div class="login_part_form_iner">
                            ...
                            <form class="row contact_form" action="" method="post" novalidate="novalidate" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12 form-group p_star">
                                    <p>Account (Email)</p>
                                    <input type="text" class="form-control"  name="email" value="<?= $taikhoancu ?>" placeholder="Account (Email)" readonly required >
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <p>Full Name*</p>
                                    <input type="text" id="hoten" class="form-control" name="hoten" required value="<?= $tencu ?>" placeholder="Full Name" required>
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <p>Phone Number*</p>
                                    <input type="text" id="sdt" class="form-control"  name="sdt" value="<?= $sdtcu ?>" placeholder="Phone Number" required>
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <p>Address*</p>
                                    <textarea type="text" id="diachi" class="form-control" cols="70" rows="2"  name="diachi" placeholder="Enter the address" required ><?= $diachicu ?></textarea>
                                </div>
                                <div class="col-md-12 form-group p_star">
                                        <p>Avatar</p>
                                ...
                                <a href="password.php" class="genric-btn primary-border small" style="float:right">Change Password</a>
                                    <div class="col-md-12 form-group p_star">
