        ...
        <div class="container">
            <div class="row justify-content-center a2">
                <div class="col-lg-8 a2">
                        <div class="a1">
                            <h2 class="addfont">Product Details</h2>
                        </div>
                </div>
            </div>
        </div>
                                        ...
                                        <?php 
                                            if (isset($_POST["addcart"])) {
                                                if (isset($_COOKIE["user"])) {
                                                    ...
                                                    echo "<script>alert('Please log in to purchase')</script>";
                                                }
                                            }
                                        ?>
                                        <input class="btn_3" name="addcart" type="submit" value="Add to Cart"/>
                                    </form>
                                </div>
                            </div>
                        <?php
    ...
    <section class="product_description_area">
        <div class="container">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="false">Describe</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="true" selected = true>Comment</a>
                </li>
            </ul>
                                                    ...
                                                    if ( $permission==1) {
                                                        ...
                                                        <div class="review_item reply">
                                                            ...
                                                            <form action="" method="POST" class="form-rep">
                                                                ...
                                                                <textarea class="form-control" name="noidungtraloi" style="width:100%;height:100px;resize:none" id="" cols="30" rows="10" placeholder="Enter reply content"></textarea>
                                                                <button type="submit" name="repcomment" class="genric-btn primary-border small" style="float: right; margin-top:5px">Reply</button>
                                                            </form>
                                                        </div>
                                                    <?php
                                                    }
                                ...
                                <form class="row contact_form" action="" method="post" novalidate="novalidate">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <textarea class="form-control" name="noidung" style="width:100%;height:100px;resize:none" id=""  placeholder="Enter the text comment"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12 text-right">
                                        <button type="submit" name="comment" class="btn_3">Send</button>
                                    </div>
                                </form>
                            </div>
                        </div>
